...
_SEARCH_TERMS = ["python", "software engineer", "devops", "qa automation", "backend", "data engineer", "machine learning", "cloud engineer", "qa", "manual qa", "automation engineer", "integration"]
_REQUEST_DELAY = 2.0
